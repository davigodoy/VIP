...
async def save_config_form(
    ...
    contagem_continua_enabled: str | None = Form(None),
    contagem_intervalo_min: int = Form(...),
    ...
    try:
        payload = RetentionConfig(
            ...
            contagem_continua_enabled=contagem_continua_enabled is not None,
            contagem_intervalo_min=contagem_intervalo_min,
